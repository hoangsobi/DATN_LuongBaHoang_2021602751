...
namespace Prj_Ban_Quan_Ao.Controllers
{
    ...
    public class AnhSanPhamsController : ControllerBase
    {
        ...
        public async Task<ActionResult> UploadImage()
        {
            ...
            const string accessKey = "CRI2CpcDqWhRz4ucwyIb"; // Replace with your actual access key
            const string secretKey = "T9aFcOjfFmFqPGpx4w9i5HSSfOkyCosZ71snyzKr"; // Replace with your actual secret key
            try
            {
